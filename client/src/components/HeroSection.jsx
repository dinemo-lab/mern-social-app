  ...
  return (
    ...
    >
                ...
                <div className="p-8 text-white h-full flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-white/80 line-clamp-3">
                      {index === 0
                        ? "Explore the narrow lanes of Chandni Chowk and discover hidden architectural gems with local history experts."
                        : index === 1
                        ? "Savor authentic Indian spices and learn traditional cooking techniques in vibrant Goan plantations."
                        : "Witness the mesmerizing evening ritual on the banks of the sacred Ganges river with spiritual guides."}
                    </p>
                  </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex -space-x-2">
                        {[...Array(3)].map((_, i) => (
                          <div
                            key={i}
                            className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-400 to-indigo-500 border-2 border-white flex items-center justify-center"
                          >
                            <span className="text-xs">
      ...
      >
        ...
        <motion.div className="w-6 h-10 rounded-full border-2 border-white/40 flex justify-center">
          <motion.div
