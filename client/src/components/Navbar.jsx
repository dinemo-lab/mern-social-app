...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white px-4 md:px-6 py-4 flex justify-between items-center shadow-lg sticky top-0 z-50">
      {/* Logo */}
      ...
      <div className="hidden md:flex space-x-6 items-center">
        <Link to="/" className="hover:text-purple-200 transition duration-150 font-medium">
          Home
        </Link>
        {user && (
          <Link
            to="/create-visit"
            className="hover:text-purple-200 transition duration-150 font-medium"
          >
            Create Visit
          </Link>
        )}
        <Link to="/explore" className="hover:text-purple-200 transition duration-150 font-medium">
          Explore
        </Link>
      ...
      <div className="hidden md:block">
        {user ? (
          ...
          <div className="space-x-4">
            ...
            <Link
              to="/register"
              className="border border-white px-4 py-2 rounded-full hover:bg-purple-500 transition duration-150 font-medium"
            >
              Sign Up
            </Link>
          </div>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="absolute top-16 left-0 right-0 bg-gradient-to-r from-purple-600 to-indigo-700 shadow-lg p-4 md:hidden z-40">
            ...
            <div className="border-t border-purple-400 my-2 pt-2">
              {user ? (
                <>
                  ...
                  <Link
                    to="/profile"
                    className="hover:bg-purple-500 py-2 px-3 rounded flex items-center transition duration-150"
                    onClick={() => setIsOpen(false)}
                  >
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <Link
                    to="/register"
                    className="border border-white py-2 px-3 rounded text-center"
                    onClick={() => setIsOpen(false)}
                  >
                    Sign Up
                  </Link>
