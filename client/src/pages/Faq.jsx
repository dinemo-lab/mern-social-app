      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Local Explorer</h3>
              <p className="text-gray-300">
                Connect with locals and explore cities through authentic experiences.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/visits" className="text-gray-300 hover:text-white">Explore Visits</Link></li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Local Explorer. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
